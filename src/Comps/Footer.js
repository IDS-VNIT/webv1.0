...
function Footer() {
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Web</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">App</a>
        </p>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">Game</a>
        </p>
        <p>
  ...
  <div class="text-center p-6">
    ...
    <a class="text-gray-600 font-semibold" href="#">Institute Development Society, VNIT Nagpur</a>
  </div>
</footer>
