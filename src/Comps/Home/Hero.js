...
function Hero() {
  return (
    <div className="sm:grid grid-cols-2 mt-20 px-20">
      <div className="flex flex-col">
        ...
        <div className="sm:bg-gradient-to-r from-idsBlue to-idsGreen w-80 h-6 -mt-8 z-10 mb-6"></div>
      ...
      <div>
        <img src={BG} class="sm:w-4/5 -mt-12 h-auto" alt="..." />
